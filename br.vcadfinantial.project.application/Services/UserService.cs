...
namespace br.vcadfinantial.project.application.Services
{
    public class UserService : IUserService
    {
        ...
        public UserService(ILogger<UserService> logger, IUserRepository userRepository, AppDbContext context, IPasswordHasher<User> passwordHasher, IConfiguration configuration)
        {
            _logger = logger;
